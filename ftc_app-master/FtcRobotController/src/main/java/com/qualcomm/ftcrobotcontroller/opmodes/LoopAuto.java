...
public class LoopAuto extends OpMode {
    LightSensor light;
    ...
    */
    ...
    public void loop() {
        ...
        switch (currentState) {
            ...
            case LIGHT:
                if (light.getLightDetected() > .54) {
                    motorLeft.setPower(.8);
                    motorRight.setPower(-.8);
            }
                if (light.getLightDetected() < .53) {
            ...
            case RETRACTWINCH:
                if (pathComplete()) {
                    ...
                    telemetry.addData("RETRACT", "good");
                }
                break;
            //stop a few inches before, extend arm more
